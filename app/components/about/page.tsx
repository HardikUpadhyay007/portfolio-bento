...
export default function About() {
    ...
    return (
        <div className="grid grid-rows-8 grid-cols-4 lg:grid-cols-3 gap-5">
            ...
            <Card className="col-span-full row-start-2 row-end-3 lg:row-start-2 lg:col-start-1 lg:col-span-1 bg-gray-600 opacity-0 mobile-animation professionCard">
            ...
            <Card className="hidden lg:flex col-span-2 lg:row-start-3 lg:row-span-1 lg:col-start-3 lg:col-span-1 bg-gray-600 opacity-0 mobile-animation quoteCard">
